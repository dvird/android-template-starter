...
import com.example.android.todoapp.data.source.local.FakeTaskDao
import com.example.android.todoapp.data.source.network.FakeRemoteTaskDataSource
import com.example.android.todoapp.data.task.DefaultTaskRepository
import com.example.android.todoapp.data.task.Task
import com.example.android.todoapp.data.task.source.toLocal
import com.example.android.todoapp.data.task.source.toNetwork
...
class DefaultTaskRepositoryTest {
    ...
    // Test dependencies
    private lateinit var networkDataSource: FakeRemoteTaskDataSource
    ...
    fun createRepository() {
        networkDataSource = FakeRemoteTaskDataSource(networkTasks.toMutableList())
        localDataSource = FakeTaskDao(localTasks)
        // Get a reference to the class under test
        taskRepository = DefaultTaskRepository(
            remoteTaskDataSource = networkDataSource,
