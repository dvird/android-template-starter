...
import com.example.android.todoapp.data.task.source.toExternal
 ...
 *
 * @param remoteTaskDataSource - The network data source
...
class DefaultTaskRepository @Inject constructor(
    ...
    override suspend fun refresh() {
        withContext(dispatcher) {
            val remoteTasks = remoteTaskDataSource.loadTasks()
            localDataSource.deleteAll()
    ...
    private fun saveTasksToNetwork() {
        scope.launch {
            try {
                ...
                remoteTaskDataSource.saveTasks(networkTasks)
            } catch (e: Exception) {
